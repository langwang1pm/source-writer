...
async def get_segment_detail(document_id: str, chunk_id: str):
    ...
    Returns the segment detail with an extra 'title' field extracted from content.
    """
    from app.utils.citation_parser import extract_title_from_content
    ...
    if isinstance(result, dict):
        result["title"] = extract_title_from_content(result.get("content"))
    return result
